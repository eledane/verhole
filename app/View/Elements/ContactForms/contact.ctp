...
$this->assign('formCreate', $this->Form->create('Contact', array('url' => $this->Html->getAbsoluteLangLink('/leaveContact/contact'), 'class' => 'hc-form')));
?>
	<div class="row default-contact-agreement">
